...
Eliminate damaging startup surges &amp; protect your inverter! Our Soft Starter ensures smooth, reliable starts for 1-2.5HP, 220V motors (pumps, compressors, HVAC). Prevents tripping, extends motor life, and is easy to install. Delivery across Pakistan. Contact: 03342159444.
...
# Perfect For
- Solar/Inverter-powered water pumps
- Air compressors
- HVAC systems
- Industrial machinery. 
- compatible with 1 HP, 1.5 HP, 2HP and 2.5HP submersible pump / summer pump (extremely relible)
- Also compatible with Lal-Pumps (motors)
# "The smarter start for your motor. "
project:  
-project will be box pack and will be ready use/install. 
delievery:
